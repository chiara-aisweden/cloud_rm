...
def objective(trial):
    ...
    n_nodes = trial.suggest_int('n_nodes',200,400,25)
    ...
    f=open('optuna/testdata2.txt','a')
    f.write('layers: '+str(hidd_n_layers)+', nodes: '+str(n_nodes)+', lr: '+str(lr)+'; MSE= '+str(mse)+'\n')
    f.close()
...
joblib.dump(study, "optuna/fullstudy2.pkl")